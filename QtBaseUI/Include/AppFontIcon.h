...
//------------------------------------------------------------------------------------------------------------------------------------------------
class QTBASEUI_EXPORT AppFontIcon : public QObject
{
	Q_OBJECT

public:
    static bool initFontAwesome();
	static void setDefaultBlackStyle();
    static void setDefaultStyle(const QString& name, const QVariant& value );

	static QFont getFont(int size);
    static QIcon getIcon(int character, const QVariantMap& options = QVariantMap());
    static QIcon getIcon(const QString& name, const QVariantMap& options = QVariantMap());
    static QIcon getIcon(const QVariantMap& optionMap = QVariantMap());

private:
    static QString strFontName;
	static QVariantMap iconStyles;
    static QHash<QString,int> mapNameCode;             
};

//------------------------------------------------------------------------------------------------------------------------------------------------
class AppFontPainterIconEngine : public QIconEngine
{

public:
	AppFontPainterIconEngine(const QVariantMap & options);
	~AppFontPainterIconEngine();

public:
	virtual AppFontPainterIconEngine * AppFontPainterIconEngine::clone() const;
